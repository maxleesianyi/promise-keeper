...
- The chat now inherits the dashboard’s light and midnight themes, uses the supplied Do Already? mark, sends with Enter, and is toggled open or closed through the same **Try it out** button.
